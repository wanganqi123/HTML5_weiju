...
<div class="body">
	...
	<div class="right">
		...
		<div class="denglu">
       	 <a href="index.html"><input type="button" style="background:url(images/登录_u17.png) no-repeat; border:none; color:black; width:84px; height:20px;" value="登录" /></a>
       	 <input type="button" style="background:url(images/登录_u17.png) no-repeat; border:none; color:black; width:84px; height:20px;" value="注册" />
       	 </div>
       	 </div>
