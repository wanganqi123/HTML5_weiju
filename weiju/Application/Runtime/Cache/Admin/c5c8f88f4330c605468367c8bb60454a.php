...
<div class="container clearfix">
 ...
 <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/user/index');?>">用户管理</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/user/edit');?>">编辑用户</a></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($user["name"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>密码：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($user["password"]); ?>" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>用户类型：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($user["type"]); ?>" type="text">
                                </td>
                            </tr>
 ...
 -->
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo U('Admin/user/index');?>"><input class="btn btn6" onclick="history.go(-1)" value="返回" type="button"> 
                                </td>
                            </tr>
                        </tbody>
                    </table>
