                    ...
                    <table class="result-tab" width="100%">
                        <tr>
                         ...
                         <?php if(is_array($board)): $i = 0; $__LIST__ = $board;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/board/edit');?>/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/board/destroy');?>/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
