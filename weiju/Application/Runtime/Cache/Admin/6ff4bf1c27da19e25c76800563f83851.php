                    ...
                    <table class="result-tab" width="100%">
                        <tr>
                         ...
                         <?php if(is_array($sight)): $i = 0; $__LIST__ = $sight;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/sight/edit');?>/id/<?php echo ($vo["sigid"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/sight/destroy');?>/id/<?php echo ($vo["sigid"]); ?>">删除</a>
                            </td>
