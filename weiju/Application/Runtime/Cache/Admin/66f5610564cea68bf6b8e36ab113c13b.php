                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($strategy)): $i = 0; $__LIST__ = $strategy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/strategy/edit');?>/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/strategy/destroy');?>/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
