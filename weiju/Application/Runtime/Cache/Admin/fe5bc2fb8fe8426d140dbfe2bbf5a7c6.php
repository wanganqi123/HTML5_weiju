                ...
                <form action="<?php echo U('Admin/strategy/store');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                                ...
                                <td>
                                    <input class="common-text required" id="thumb" name="thumb" size="50" value="<?php echo ($strategy["title"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>上传时间</th>
                                <td>
                                    <input class="common-text required" id="price" name="price" size="50" value="<?php echo ($strategy["ptime"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>攻略内容</th>
                                <td><input name="smallimg" id="" type="text" value="<?php echo ($strategy["content"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>关键词</th>
                                <td><input type="text" value="<?php echo ($strategy["key"]); ?>"></td>
                            </tr>
                            <tr>
                                <th>游玩时长</th>
                                <td><input type="text" value="<?php echo ($strategy["date"]); ?>"></td>
                            </tr>
                            <tr>
