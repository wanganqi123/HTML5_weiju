            ...
            <div class="result-content">
                <form action="<?php echo U('Admin/sight/update');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>景点名：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($sight["name"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>所属城市：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($sight["city"]); ?>" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>四季最佳：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($sight["season"]); ?>" type="text">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="textarea" value="<?php echo ($sight["summary"]); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>地址：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($sight["address"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>缩略图：</th>
                                <td>
                                <img src="/weiju/Public/<?php echo ($sight["pic"]); ?>" width="300px" height="50px"/>
                                <input name="pic" id="" type="file"></td>
                            </tr>
