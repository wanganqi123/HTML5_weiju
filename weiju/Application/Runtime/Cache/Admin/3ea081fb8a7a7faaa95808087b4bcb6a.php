...
<div class="container clearfix">
 ...
 <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/hotel/index');?>">酒店管理</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="<?php echo U('Admin/hotel/edit');?>">编辑酒店</a></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo U('Admin/hotel/update');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>酒店名：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($hotel["name"]); ?>" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>所属城市：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($hotel["city"]); ?>" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>酒店类型：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title"  value="<?php echo ($hotel["type"]); ?>" type="text">
                                </td>
                            </tr>
                            
                            <tr>
                                <th><i class="require-red">*</i>酒店电话：</th>
                                <td>
                                <input class="common-text required" id="title" name="title"  value="<?php echo ($hotel["number"]); ?>" type="text">
                            </td>
                            </tr>

                            <tr>
                                <th><i class="require-red">*</i>酒店价格：</th>
                                <td>
                                <input class="common-text required" id="title" name="title"  value="<?php echo ($hotel["price"]); ?>" type="text">
                            </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>酒店地址：</th>
                                <td>
                                <input class="common-text required" id="title" name="title"  value="<?php echo ($hotel["address"]); ?>" type="text">
                            </td>
                            </tr>
