				...
				<div class="hl">
	                ...
	                <div class="menu">
	                    <ul>
	                        ...
	                        <li id="ejdh2">
	                        	<a href="<?php echo U('Home/siji/sijituijian');?>" title="四季推荐" class="ejdh2" style="background-color:rgba(0,0,0,0.2)!important; filter:Alpha(opacity=30);">四季推荐</a>
	                        	<ul>
			...
			<div class="content-footer">
				...
				<div class="lanrenzhijia" id="lanrenzhijia">
					<ul>
						...
						<li class=""><a href="<?php echo U('Home/siji/sijituijian');?>">夏</a></li>
						<li class=""><a href="<?php echo U('Home/siji/sijituijian');?>">秋</a></li>
						<li class=""><a href="<?php echo U('Home/siji/sijituijian');?>">冬</a></li>
					</ul>
				...
				<div class="content-text">
					<div id="zw">
						...
						<a href="#"><img src="/weiju/Public/home/images/春1.jpg" width="100%" height="300px"></a>
						<p class="zxkk"><a href="#">仔细看看&gt;&gt;</a></p>
					</div>
					<div id="zw">
						<h1><a href="#">圣玛丽大教堂</a></h1>
						...
						<a href="#"><img src="/weiju/Public/home/images/春2.jpg" width="100%" height="300px"></a>
						<p class="zxkk"><a href="#">仔细看看&gt;&gt;</a></p>
					</div>
					<div id="zw">
						<h1><a href="#">悉尼歌剧院</a></h1>
						...
						<a href="#"><img src="/weiju/Public/home/images/春3.jpg" width="100%" height="300px"></a>
						<p class="zxkk"><a href="#">仔细看看&gt;&gt;</a></p>
					</div>
