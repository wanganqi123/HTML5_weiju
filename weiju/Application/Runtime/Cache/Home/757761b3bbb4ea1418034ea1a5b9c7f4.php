...
<head>
    ...
    <meta http-equiv="content-type" content="text/html; charset=utf-8"/>
	  <!-- <link href="css/zhunali.css" type="text/css" rel="stylesheet"/> -->
...
<div class="content">
  ...
  <div class="shxuan">
	...
	<table>
          <tr>
            <td> <label><input name="travel" type="radio" value="" />自驾之旅</label></td>
            <td><label><input name="travel" type="radio" value="" />海岸之旅</label></td>
            <td><label><input name="travel" type="radio" value="" />独特两日游</label></td>
            <td><label><input name="travel" type="radio" value="" />步行之旅</label></td>
            <td><label><input name="travel" type="radio" value="" />探险之旅</label></td>
          </tr>
          <tr>
            <td><label><input name="travel" type="radio" value="" />内地之旅</label></td>
            <td><label><input name="travel" type="radio" value="" />探索自然</label></td>
            <td><label><input name="travel" type="radio" value="" />原住民文化探索
            </label></td>
            <td></td>
            <td></td>
          </tr>
  ...
  <table>
    ...
    <form class="select">
      <select name="price">
          ...
          <option value="down">价格由高到低</option>
          <option value="up">价格由低到高</option>
      </select>
      <select name="num">
          <option value="n">销量</option>
          <option value="pdown">销量由高到低</option>
          <option value="pup">销量由低到高</option>
      </select>
      <select name="xinyong">
          <option value="x">信用</option>
          <option value="xdown">信用由高到低</option>
          <option value="xup">信用由低到高</option>
      </select>
    </form>
  </div>
</div>
...
<div class="lists">
    <div class="list">
        <div class="list_img">
           <a href="<?php echo U('Home/zhuna/zhunali_content');?>"><img src="/weiju/Public/home/images/z1.jpeg"></a>
        </div>
        <div class="list_content">
            <h2>windsor hotel</h2>
            <br/>
            <p>windsor hotel.这是一家澳洲著名的五星级酒店，以英国女王伊丽莎白曾入住而得名。酒店位于墨尔本中心地带，</p><p>走路十分钟可到名品街、唐人街。</p>  
        </div>
   </div>
   <div class="list">
        <div class="list_img">
           <a href="<?php echo U('Home/zhuna/zhunali_content');?>"><img src="/weiju/Public/home/images/z2.jpg"></a>
        </div>
        <div class="list_content">
            <h2>Port O Call Motel</h2>
            <br/>
            <p>windsor hotel.这是一家澳洲著名的五星级酒店，以英国女王伊丽莎白曾入住而得名。酒店位于墨尔本中心地带，</p><p>走路十分钟可到名品街、唐人街。</p>  
        </div>
   </div>
   <div class="list">
        <div class="list_img">
           <a href="<?php echo U('Home/zhuna/zhunali_content');?>"><img src="/weiju/Public/home/images/z3.jpg"></a>
        </div>
        <div class="list_content">
            <h2>Port O Call Motel</h2>
            <br/>
