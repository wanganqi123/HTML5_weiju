		...
		<div class="content">
			...
			<div class="content-footer">
				...
				<div class="lanrenzhijia" id="lanrenzhijia">
					<ul>
						<li class="on"><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">新南威尔士州</a></li>
						<li class=""><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">昆士兰</a></li>
						<li class=""><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">维多利亚州</a></li>
						<li class=""><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">北领地</a></li>
						<li class=""><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">南澳大利亚</a></li>
						<li class=""><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">西澳大利亚</a></li>
					</ul>
			...
			<div class="flex-container">
				...
				<div class="flex-item2">
					<div style="float:left; text-align: center;" >
					   <a href="<?php echo U('Home/liuxue/student1');?>"><img src="/weiju/Public/home/images/u32.png" height="160px" width="173px" ></a>
                       <a href="<?php echo U('Home/liuxue/student1');?>"><p>某某某</p></a>
			      	<p>澳大利亚大学留学生</p>
			      	<p>☆☆☆☆☆</p>
					</div>
					<div style="float:left;margin-left:8%;line-height: 28px;"> <p>居住在某某某城市</br>工作时间（每日更新）：周一下午周二周三全天</br>工作地点范围：新南威尔士州</br>收费：1000-2000欧元</br>是否提供接机：是</br>联系方式：  1：手机  15111111111    2：微信    xxxxxx</p></div>
				</div>
			</div>
			...
			<!-- <div class="content-text">	
			    <div id="zw">
					<div style="float:left">
			      	<a href=""><img src="images/u32.png" height="160px" width="173px"></a>
      		        ...
      		        <p>居住在某某某城市</br>工作时间（每日更新）：周一下午周二周三全天</br>工作地点范围：新南威尔士州</br>收费：1000-2000欧元</br>是否提供接机：是</br>联系方式：  1：手机  15111111111    2：微信    xxxxxx</p>
      	            </div>
                </div>
