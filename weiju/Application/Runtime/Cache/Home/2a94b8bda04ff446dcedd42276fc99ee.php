...
<html>
	...
	<link href="/weiju/Public/home/css/index.css" rel="stylesheet" type="text/css">
			...
			<div class="lheader">
				<div class="hl">
	                ...
	                <div class="menu">
	                    <ul>
	                        <li>
	                        	<a href="<?php echo U('Home/index/index');?>" title="首页" class="index" style="background-color:rgba(0,0,0,0.2)!important; filter:Alpha(opacity=30);">首页</a>
	                       	</li>
	                        <li id="ejdh1">
...
<!--************************************contant*************************************-->
		...
		<div class="content">
			<div class="yqddf">
				<div class="yqddf1">
					<div class="ddd">
						<a href="<?php echo U('Home/yaoqu/content');?>"><img src="/weiju/Public/home/images/u17.jpg"></a>
						<div class="yqddfwz">
							<ul>
								<li><a href="<?php echo U('Home/yaoqu/content');?>" class="indexa">袋鼠岛</a></li>
								<li><a href="<?php echo U('Home/yaoqu/content');?>"><label>充满爱的岛屿</label></a></li>
							</ul>
						</div>
					</div>
					<div class="dbj">
						<a href="<?php echo U('Home/yaoqu/content');?>"><img src="/weiju/Public/home/images/u21.jpg"></a>
						<div class="yqddfwz">
							<ul>
								<li><a href="<?php echo U('Home/yaoqu/content');?>" class="indexa">大堡礁</a></li>
								<li><a href="<?php echo U('Home/yaoqu/content');?>"><label>世界最大的珊瑚礁群</label></a></li>
							</ul>
						</div>
					</div>
					<div class="xn">
						<a href="<?php echo U('Home/yaoqu/content');?>"><img src="/weiju/Public/home/images/u19.jpg"></a>
						<div class="yqddfwz">
							<ul>
								<li><a href="<?php echo U('Home/yaoqu/content');?>" class="indexa">悉尼</a></li>
								<li><a href="<?php echo U('Home/yaoqu/content');?>"><label>世界著名的国际大都市</label></a></li>
							</ul>
						</div>
					</div>
					</div>
					<div class="yqddf2">
					<div class="bly">
						<a href="<?php echo U('Home/yaoqu/content');?>"><img src="/weiju/Public/home/images/u37.jpg"></a>
						<div class="yqddfwz">
							<ul>
								<li><a href="<?php echo U('Home/yaoqu/content');?>" class="indexa">波浪岩</a></li>
								<li><a href="<?php echo U('Home/yaoqu/content');?>"><label>澳大利亚最奇特的景观</label></a></li>
							</ul>
						</div>
					</div>
					<div class="lbt">
						<a href="<?php echo U('Home/yaoqu/content');?>"><img src="/weiju/Public/home/images/u187.jpg"></a>
					</div>
					<div class="xndq">
						<a href="<?php echo U('Home/yaoqu/content');?>"><img src="/weiju/Public/home/images/u45.jpg"></a>
						<div class="yqddfwz">
							<ul>
								<li><a href="<?php echo U('Home/yaoqu/content');?>" class="indexa">悉尼大桥</a></li>
								<li><a href="<?php echo U('Home/yaoqu/content');?>"><label>世界第一单孔拱桥</label></a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="gd1"><a href="<?php echo U('Home/yaoqu/content');?>">更多&gt;&gt;</a></div>
			
			</div>
			<div class="sjtj">
				<div class="sjtj1"><a href="<?php echo U('Home/siji/sijituijian');?>">四季推荐</a></div>
				<div class="sjtjsm"><label>无论是春夏时节还是秋冬时节，爱春夏还是爱秋冬，总有一季适合你</label></div>
				<div class="sjtjnr">
					<div class="spring">
						<a href="<?php echo U('Home/siji/sijituijian');?>"><img src="/weiju/Public/home/images/u143.jpg"></a>
						<p><a href="<?php echo U('Home/siji/sijituijian');?>">春暖花开</a></p>
					</div>
					<div class="summer">
						<a href="<?php echo U('Home/siji/sijituijian');?>"><img src="/weiju/Public/home/images/u145.jpg"></a>
						<p><a href="<?php echo U('Home/siji/sijituijian');?>">夏阳酷暑</a></p>
					</div>
					<div class="autumn">
						<a href="<?php echo U('Home/siji/sijituijian');?>"><img src="/weiju/Public/home/images/u147.jpg"></a>
						<p><a href="<?php echo U('Home/siji/sijituijian');?>">秋高气爽</a></p>
					</div>
					<div class="winter">
						<a href="<?php echo U('Home/siji/sijituijian');?>"><img src="/weiju/Public/home/images/u149.jpg"></a>
						<p><a href="<?php echo U('Home/siji/sijituijian');?>">冰天雪地</a></p>
					</div>
				</div>
			</div>
			<div class="xctj">
				<div class="xctj1"><a href="xingcheng.html">精彩行程推荐</a></div>
				<div class="xctjsm"><label>无论是自驾族还是背包客，爱美景还是爱美食，总能找到适合你的路线</label></div>
				<div class="xctjnr">
					<div class="xctjnr1">
						<div class="hazl">
							<a href="<?php echo U('Home/xingcheng/xingcheng_content');?>"><img src="/weiju/Public/home/images/u67.jpg"></a>
							<p><a href="<?php echo U('Home/xingcheng/xingcheng_content');?>">海岸之旅</a></p>
						</div>
						<div class="mebdkes">
							<a href="<?php echo U('Home/xingcheng/xingcheng_content');?>"><img src="/weiju/Public/home/images/u71.jpg"></a>
							<p><a href="<?php echo U('Home/xingcheng/xingcheng_content');?>">墨尔本到凯恩斯</a></p>
						</div>
						<div class="dyldmeb">
							<a href="<?php echo U('Home/xingcheng/xingcheng_content');?>"><img src="/weiju/Public/home/images/u69.jpg"></a>
							<p><a href="<?php echo U('Home/xingcheng/xingcheng_content');?>">大洋路到墨尔本</a></p>
						</div>
						<div class="dbj11">
							<a href="<?php echo U('Home/xingcheng/xingcheng_content');?>"><img src="/weiju/Public/home/images/u73.jpg"></a>
							<p><a href="<?php echo U('Home/xingcheng/xingcheng_content');?>">大堡礁</a></p>
						</div>
					</div>
					<div class="xctjnr2">
						<a href="<?php echo U('Home/xingcheng/xingcheng_content');?>"><img src="/weiju/Public/home/images/u75.jpg"></a>
						<p><a href="<?php echo U('Home/xingcheng/xingcheng_content');?>">澳大利亚自驾游篇</a></p>
					</div>
					<div class="gd2"><a href="<?php echo U('Home/xingcheng/xingcheng');?>">更多&gt;&gt;</a></div>
				</div>
			</div>
			<div class="ykxz">
				<div class="ykxz1"><label>提醒一下哦（游客须知概况）</label></div>
				<div class="ykxznr">
					<div class="gyqz">
						<a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>"><img src="/weiju/Public/home/images/u55.jpg"></a>
						<p><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">关于签证</a></p>
					</div>
					<div class="gytq">
						<a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>"><img src="/weiju/Public/home/images/u57.jpg"></a>
						<p><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">关于天气</a></p>
					</div>
					<div class="gyadly">
						<a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>"><img src="/weiju/Public/home/images/u59.jpg"></a>
						<p><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">关于澳大利亚</a></p>
					</div>
					<div class="gd3"><a href="<?php echo U('Home/zhuyi/zhuyishixiang');?>">更多&gt;&gt;</a></div>
				</div>
			</div>
		</div>
